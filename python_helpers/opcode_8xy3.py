for x in range(16):
    with open(f'..\\data\\cpu\\functions\\opcode_switch\\opcode_8xx3\\opcode_8xx3_{x}.mcfunction', 'w') as f:
        ...
        for i in range(16):
            f.write(f'execute if score Global PC_nibble_3 matches {i} run function cpu:opcode_switch/opcode_8xx3/opcode_8xx3_{x}-{i}\n')

for x in range(16):
    for i in range(16):
        with open(f'..\\data\\cpu\\functions\\opcode_switch\\opcode_8xx3\\opcode_8xx3_{x}-{i}.mcfunction', 'w') as f:
            f.write(f'scoreboard players operation Global bitwise_2 = Global V{hex(i)[2:].upper()}\n'
                    ...
                    f'function cpu:bitwise_ops/xor\n'
...
"""
for x in range(16):
    with open('..\\data\\cpu\\functions\\opcode_switch\\opcode_8xx3.mcfunction', 'a') as f:
        f.write(f'execute if score Global PC_nibble_2 matches {x} run function cpu:opcode_switch/opcode_8xx3/opcode_8xx3_{x}\n')
"""
