execute if score Global VD > Global VD run scoreboard players set Global VF 1
execute unless score Global VD > Global VD run scoreboard players set Global VF 0
