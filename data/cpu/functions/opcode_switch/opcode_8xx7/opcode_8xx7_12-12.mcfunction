execute if score Global VC > Global VC run scoreboard players set Global VF 1
execute unless score Global VC > Global VC run scoreboard players set Global VF 0
