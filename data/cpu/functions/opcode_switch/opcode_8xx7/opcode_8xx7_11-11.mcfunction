execute if score Global VB > Global VB run scoreboard players set Global VF 1
execute unless score Global VB > Global VB run scoreboard players set Global VF 0
