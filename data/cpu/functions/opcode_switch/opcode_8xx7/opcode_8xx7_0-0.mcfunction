execute if score Global V0 > Global V0 run scoreboard players set Global VF 1
execute unless score Global V0 > Global V0 run scoreboard players set Global VF 0
