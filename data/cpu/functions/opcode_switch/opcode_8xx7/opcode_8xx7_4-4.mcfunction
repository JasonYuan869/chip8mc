execute if score Global V4 > Global V4 run scoreboard players set Global VF 1
execute unless score Global V4 > Global V4 run scoreboard players set Global VF 0
