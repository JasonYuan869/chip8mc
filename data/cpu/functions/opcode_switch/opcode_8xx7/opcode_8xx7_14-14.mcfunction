execute if score Global VE > Global VE run scoreboard players set Global VF 1
execute unless score Global VE > Global VE run scoreboard players set Global VF 0
