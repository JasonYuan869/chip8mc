execute if score Global V1 > Global V1 run scoreboard players set Global VF 1
execute unless score Global V1 > Global V1 run scoreboard players set Global VF 0
