execute if score Global V6 > Global V6 run scoreboard players set Global VF 1
execute unless score Global V6 > Global V6 run scoreboard players set Global VF 0
