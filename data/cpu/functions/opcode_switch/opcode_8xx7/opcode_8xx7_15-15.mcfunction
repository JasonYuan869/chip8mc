execute if score Global VF > Global VF run scoreboard players set Global VF 1
execute unless score Global VF > Global VF run scoreboard players set Global VF 0
