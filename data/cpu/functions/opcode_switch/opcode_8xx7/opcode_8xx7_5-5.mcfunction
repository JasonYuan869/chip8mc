execute if score Global V5 > Global V5 run scoreboard players set Global VF 1
execute unless score Global V5 > Global V5 run scoreboard players set Global VF 0
