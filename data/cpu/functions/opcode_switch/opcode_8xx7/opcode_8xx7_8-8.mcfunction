execute if score Global V8 > Global V8 run scoreboard players set Global VF 1
execute unless score Global V8 > Global V8 run scoreboard players set Global VF 0
