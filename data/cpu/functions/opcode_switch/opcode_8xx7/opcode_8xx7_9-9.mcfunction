execute if score Global V9 > Global V9 run scoreboard players set Global VF 1
execute unless score Global V9 > Global V9 run scoreboard players set Global VF 0
