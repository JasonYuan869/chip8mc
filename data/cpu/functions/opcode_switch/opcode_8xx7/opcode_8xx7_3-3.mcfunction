execute if score Global V3 > Global V3 run scoreboard players set Global VF 1
execute unless score Global V3 > Global V3 run scoreboard players set Global VF 0
