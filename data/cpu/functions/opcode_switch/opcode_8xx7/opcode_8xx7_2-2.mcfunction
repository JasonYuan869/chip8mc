execute if score Global V2 > Global V2 run scoreboard players set Global VF 1
execute unless score Global V2 > Global V2 run scoreboard players set Global VF 0
