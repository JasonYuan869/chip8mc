execute if score Global V7 > Global V7 run scoreboard players set Global VF 1
execute unless score Global V7 > Global V7 run scoreboard players set Global VF 0
