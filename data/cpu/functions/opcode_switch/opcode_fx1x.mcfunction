# Fx15, Fx18, Fx1E
execute unless score Global PC_nibble_4 matches 5 unless score Global PC_nibble_4 matches 8 unless score Global PC_nibble_4 matches 14 run cpu:opcode_switch/unknown_opcode
